...
import unlu.doble_enlace.Nodo;

public class Lista_doble_enlace {
    ...
    public boolean eliminar(Integer posicion){ //la posicion de la lista que quiere eliminar
        ...
        if (primer == null){
            ...
            if (i == posicion){
                ...
                primer.setAnterior(null); //seteo el anterior como nulo para eliminar el enlace con el primer nodo
                ...
                while (nodoAux.getSiguiente() != null) {
                    ...
                    if (i == posicion){
                        ...
                        nodoAux.setAnterior(nodoAux2.getAnterior());
                        return eliminacion = true;
                    }
                    nodoAux = nodoAux.getSiguiente();
                }
    ...
    public Object insertar(Integer posicion, Object Dato){
        ...
        Nodo nodoAux = primer;
        if (i == posicion){
            primer.setAnterior(nuevo_Nodo); //seteamos la posicion del nodo actual primero con la posicion del nuevo nodo primero
